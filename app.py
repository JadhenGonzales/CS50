...
def index():
    ...
    shares = db.execute("""SELECT symbol,
                                  SUM(shares)
                             FROM transactions
    ...
    for stock in shares:
        try:
            ...
            stock['total'] = stock['SUM(shares)'] * stock['value']
        except:
            pass
    ...
    return render_template("portfolio.html", shares=shares, cash=current_balance, total=total)
